...
async function run() {
  ...
  const result = await sdk.accountsReceivable.directIncomes.list({
...
async function run() {
  ...
  const directIncomeId = "<value>";
  
  const result = await sdk.accountsReceivable.directIncomes.get(companyId, connectionId, directIncomeId);
...
async function run() {
  ...
  const result = await sdk.accountsReceivable.directIncomes.getAttachment({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
...
async function run() {
  ...
  const result = await sdk.accountsReceivable.directIncomes.downloadAttachment(companyId, connectionId, directIncomeId, attachmentId);
...
async function run() {
  ...
  const result = await sdk.accountsReceivable.directIncomes.listAttachments(companyId, connectionId, directIncomeId);
