...
async function run() {
  ...
  const result = await sdk.financialStatements.profitAndLoss.getCategorizedAccounts(companyId, reportDate, numberOfPeriods);
...
| `reportDate`                                                                                                                                                                   | *string*                                                                                                                                                                       | :heavy_minus_sign:                                                                                                                                                             | The date in which the report is created up to. Users must specify a specific date, however the response will be provided for the full month.                                   | [object Object]                                                                                                                                                                |
...
async function run() {
  ...
  const result = await sdk.financialStatements.profitAndLoss.get(companyId, periodLength, periodsToCompare, startMonth);
