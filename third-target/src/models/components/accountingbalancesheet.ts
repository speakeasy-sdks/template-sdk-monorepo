...
export namespace AccountingBalanceSheet$ {
    ...
    export const inboundSchema: z.ZodType<AccountingBalanceSheet, z.ZodTypeDef, Inbound> = z
        .object({
            currency: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingBalanceSheet> = z
        .object({
            currency: z.string(),
