...
import { AccountingTransfer, AccountingTransfer$ } from "./accountingtransfer";
...
export namespace AccountingTransfers$ {
    export type Inbound = {
        results?: Array<AccountingTransfer$.Inbound> | undefined;
        pageNumber: number;
        pageSize: number;
        totalResults: number;
    ...
    export const inboundSchema: z.ZodType<AccountingTransfers, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingTransfers> = z
        .object({
