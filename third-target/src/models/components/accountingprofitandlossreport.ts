...
export namespace AccountingProfitAndLossReport$ {
    ...
    export const inboundSchema: z.ZodType<AccountingProfitAndLossReport, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingProfitAndLossReport> =
        z
            .object({
