...
import { PaymentLinkType, PaymentLinkType$ } from "./paymentlinktype";
...
export namespace PaymentLineLink$ {
    ...
    export const inboundSchema: z.ZodType<PaymentLineLink, z.ZodTypeDef, Inbound> = z
        .object({
            type: PaymentLinkType$,
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PaymentLineLink> = z
        .object({
            type: PaymentLinkType$,
            id: z.string().optional(),
            amount: z
