...
import { CommerceCustomerRef, CommerceCustomerRef$ } from "./commercecustomerref";
import { LocationRef, LocationRef$ } from "./locationref";
import { OrderLineItem, OrderLineItem$ } from "./orderlineitem";
import { PaymentRef, PaymentRef$ } from "./paymentref";
import { ServiceCharge, ServiceCharge$ } from "./servicecharge";
...
export namespace CommerceOrder$ {
    export type Inbound = {
        ...
        orderLineItems?: Array<OrderLineItem$.Inbound> | undefined;
        payments?: Array<PaymentRef$.Inbound> | undefined;
        serviceCharges?: Array<ServiceCharge$.Inbound> | undefined;
        locationRef?: LocationRef$.Inbound | undefined;
        customerRef?: CommerceCustomerRef$.Inbound | undefined;
        supplementalData?: SupplementalData$.Inbound | undefined;
        createdDate?: string | undefined;
    };

    export const inboundSchema: z.ZodType<CommerceOrder, z.ZodTypeDef, Inbound> = z
        .object({
        ...
        .transform((v) => {
            return {
                ...
                ...(v.closedDate === undefined ? null : { closedDate: v.closedDate }),
                ...(v.totalAmount === undefined ? null : { totalAmount: v.totalAmount }),
                ...(v.totalRefund === undefined ? null : { totalRefund: v.totalRefund }),
                ...
                ...(v.totalGratuity === undefined ? null : { totalGratuity: v.totalGratuity }),
                ...(v.orderLineItems === undefined ? null : { orderLineItems: v.orderLineItems }),
                ...(v.payments === undefined ? null : { payments: v.payments }),
                ...(v.serviceCharges === undefined ? null : { serviceCharges: v.serviceCharges }),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CommerceOrder> = z
        .object({
            modifiedDate: z.string().optional(),
            sourceModifiedDate: z.string().optional(),
            id: z.string(),
