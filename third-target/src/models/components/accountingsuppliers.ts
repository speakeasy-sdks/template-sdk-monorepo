...
import { AccountingSupplier, AccountingSupplier$ } from "./accountingsupplier";
...
export namespace AccountingSuppliers$ {
    export type Inbound = {
        results?: Array<AccountingSupplier$.Inbound> | undefined;
        pageNumber: number;
        pageSize: number;
        totalResults: number;
    ...
    export const inboundSchema: z.ZodType<AccountingSuppliers, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingSuppliers> = z
        .object({
