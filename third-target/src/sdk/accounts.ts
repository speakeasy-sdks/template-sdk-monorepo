...
export class Accounts extends ClientSDK {
     ...
     */
    async list(
        input: operations.ListAccountingAccountsRequest,
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.ListAccountingAccountsResponse$.inboundSchema.parse({
                        ...responseFields$,
                        AccountingAccounts: val$,
                    });
                },
    ...
    async get(
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetAccountingAccountResponse$.inboundSchema.parse({
                        ...responseFields$,
                        AccountingAccount: val$,
                    });
                },
                "Response validation failed"
            );
