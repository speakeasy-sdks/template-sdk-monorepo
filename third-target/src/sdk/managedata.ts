...
export class ManageData extends ClientSDK {
    ...
    async getStatus(
        ...
        const input$: operations.GetDataStatusRequest = {
            companyId: companyId,
        };
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.GetDataStatusRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetDataStatusResponse$.inboundSchema.parse({
                        ...responseFields$,
                        "Data statuses": val$,
                    });
                },
