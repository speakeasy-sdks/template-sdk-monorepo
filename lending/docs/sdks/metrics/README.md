...
import { PeriodUnit } from "@speakeasy-sdks/lending/models/components";
...
async function run() {
  ...
  const result = await sdk.sales.metrics.getRevenue({
...
async function run() {
  ...
  const result = await sdk.sales.metrics.getCustomerRetention({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    reportDate: "29-09-2020",
    periodLength: 497588,
...
async function run() {
  ...
  const result = await sdk.sales.metrics.getLifetimeValue({
    companyId: "8a210b68-6988-11ed-a1eb-0242ac120002",
    connectionId: "2e9d2c44-f675-40ba-8049-353bfcb5e171",
    reportDate: "29-09-2020",
    periodLength: 900865,
