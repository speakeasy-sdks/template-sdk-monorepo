...
import { GetBankingTransactionCategoryRequest } from "lending/dist/sdk/models/operations";
...
const transactionCategoryId: string = "string";

  const res = await sdk.banking.transactionCategories.get(companyId, connectionId, transactionCategoryId);
