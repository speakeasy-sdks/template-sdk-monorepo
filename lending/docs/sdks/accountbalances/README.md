...
async function run() {
  ...
  const res = await sdk.banking.accountBalances.list({
...
| ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                        | [operations.ListBankingAccountBalancesRequest](../../sdk/models/operations/listbankingaccountbalancesrequest.md) | :heavy_check_mark:                                                                                               | The request object to use for the request.                                                                       |
...
**Promise<[operations.ListBankingAccountBalancesResponse](../../sdk/models/operations/listbankingaccountbalancesresponse.md)>**
### Errors
