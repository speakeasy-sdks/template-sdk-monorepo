...
import { GetAccountingJournalRequest } from "lending/dist/sdk/models/operations";
...
const journalId: string = "string";

  const res = await sdk.transactions.journals.get(companyId, journalId);
...
**Promise<[operations.GetAccountingJournalResponse](../../sdk/models/operations/getaccountingjournalresponse.md)>**
### Errors
...
async function run() {
  ...
  const res = await sdk.transactions.journals.list({
...
**Promise<[operations.ListAccountingJournalsResponse](../../sdk/models/operations/listaccountingjournalsresponse.md)>**
### Errors
