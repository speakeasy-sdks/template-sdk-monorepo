...
import { GetCommercePaymentMethodRequest } from "lending/dist/sdk/models/operations";
...
const paymentMethodId: string = "<value>";
  ...
  const res = await sdk.sales.paymentMethods.get(companyId, connectionId, paymentMethodId);
