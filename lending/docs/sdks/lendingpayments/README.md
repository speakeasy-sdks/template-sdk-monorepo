...
async function run() {
  ...
  const res = await sdk.loanWriteback.payments.create({
    accountingPayment: {
      accountRef: {},
      currency: "USD",
      customerRef: {
...
**Promise<[operations.GetCreatePaymentModelResponse](../../sdk/models/operations/getcreatepaymentmodelresponse.md)>**
### Errors
