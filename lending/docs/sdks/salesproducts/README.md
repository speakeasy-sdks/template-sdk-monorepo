...
import { GetCommerceProductRequest } from "openapi/dist/sdk/models/operations";
...
const productId: string = "female";

  const res = await sdk.sales.products.get(companyId, connectionId, productId);
