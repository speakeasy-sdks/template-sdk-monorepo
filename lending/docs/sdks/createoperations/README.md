...
async function run() {
  ...
  const pushOperationKey = "b18d8d81-fd7b-4764-a31e-475cb1f36591";
  
  const result = await sdk.loanWriteback.createOperations.get(companyId, pushOperationKey);
...
async function run() {
  ...
  const result = await sdk.loanWriteback.createOperations.list({
