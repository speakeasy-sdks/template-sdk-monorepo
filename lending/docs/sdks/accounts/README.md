...
const connectionId: string = "2e9d2c44-f675-40ba-8049-353bfcb5e171";
  ...
  const res = await sdk.accountingBankData.accounts.get(accountId, companyId, connectionId);
...
**Promise<[operations.GetAccountingBankAccountResponse](../../sdk/models/operations/getaccountingbankaccountresponse.md)>**
### Errors
...
async function run() {
  ...
  const res = await sdk.accountingBankData.accounts.list({
...
| ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                        | [operations.ListAccountingBankAccountsRequest](../../sdk/models/operations/listaccountingbankaccountsrequest.md) | :heavy_check_mark:                                                                                               | The request object to use for the request.                                                                       |
| `retries`                                                                                                        | [utils.RetryConfig](../../internal/utils/retryconfig.md)                                                         | :heavy_minus_sign:                                                                                               | Configuration to override the default retry behavior of the client.                                              |
| `config`                                                                                                         | [AxiosRequestConfig](https://axios-http.com/docs/req_config)                                                     | :heavy_minus_sign:                                                                                               | Available config options for making requests.                                                                    |
...
**Promise<[operations.ListAccountingBankAccountsResponse](../../sdk/models/operations/listaccountingbankaccountsresponse.md)>**
### Errors
