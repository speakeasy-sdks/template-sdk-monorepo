...
import { GetAccountingBillCreditNoteRequest } from "lending/dist/sdk/models/operations";
...
const companyId: string = "8a210b68-6988-11ed-a1eb-0242ac120002";
  ...
  const res = await sdk.accountsPayable.billCreditNotes.get(billCreditNoteId, companyId);
...
**Promise<[operations.GetAccountingBillCreditNoteResponse](../../sdk/models/operations/getaccountingbillcreditnoteresponse.md)>**
### Errors
...
(async() => {
  ...
  const res = await sdk.accountsPayable.billCreditNotes.list({
...
**Promise<[operations.ListAccountingBillCreditNotesResponse](../../sdk/models/operations/listaccountingbillcreditnotesresponse.md)>**
### Errors
