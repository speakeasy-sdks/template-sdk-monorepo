...
async function run() {
  ...
  const result = await sdk.accountsPayable.suppliers.list({
...
async function run() {
  ...
  const result = await sdk.accountsPayable.suppliers.get(companyId, supplierId);
...
async function run() {
  ...
  const result = await sdk.accountsPayable.suppliers.listAttachments(companyId, connectionId, supplierId);
...
async function run() {
  ...
  const result = await sdk.accountsPayable.suppliers.getAttachment(companyId, connectionId, supplierId, attachmentId);
...
async function run() {
  ...
  const result = await sdk.accountsPayable.suppliers.downloadAttachment(companyId, connectionId, supplierId, attachmentId);
