...
async function run() {
  ...
  const result = await sdk.bankStatements.getUploadConfiguration(companyId, connectionId);
...
**Promise<[operations.GetBankStatementUploadConfigurationResponse](../../models/operations/getbankstatementuploadconfigurationresponse.md)>**
### Errors
...
async function run() {
  ...
  const companyId = "8a210b68-6988-11ed-a1eb-0242ac120002";
  const connectionId = "2e9d2c44-f675-40ba-8049-353bfcb5e171";
  const bankStatementUploadConfiguration = {};
  
  const result = await sdk.bankStatements.setUploadConfiguration(companyId, connectionId, bankStatementUploadConfiguration);
...
**Promise<[operations.SetBankStatementUploadConfigurationResponse](../../models/operations/setbankstatementuploadconfigurationresponse.md)>**
### Errors
...
async function run() {
  ...
  const companyId = "8a210b68-6988-11ed-a1eb-0242ac120002";
  const connectionId = "2e9d2c44-f675-40ba-8049-353bfcb5e171";
  const startUploadSessionRequest = {};
  
  const result = await sdk.bankStatements.startUploadSession(companyId, connectionId, startUploadSessionRequest);
...
**Promise<[operations.StartBankStatementUploadSessionResponse](../../models/operations/startbankstatementuploadsessionresponse.md)>**
### Errors
...
async function run() {
  ...
  const companyId = "8a210b68-6988-11ed-a1eb-0242ac120002";
  const connectionId = "2e9d2c44-f675-40ba-8049-353bfcb5e171";
  const datasetId = "d58db2ab-edef-4881-8b6b-a7e79d33244c";
  const endUploadSessionRequest = {};
  
  const result = await sdk.bankStatements.endUploadSession(companyId, connectionId, datasetId, endUploadSessionRequest);
...
**Promise<[operations.EndBankStatementUploadSessionResponse](../../models/operations/endbankstatementuploadsessionresponse.md)>**
### Errors
