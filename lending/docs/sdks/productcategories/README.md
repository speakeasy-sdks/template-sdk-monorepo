...
import { GetCommerceProductCategoryRequest } from "lending/dist/sdk/models/operations";
...
**Promise<[operations.GetCommerceProductCategoryResponse](../../sdk/models/operations/getcommerceproductcategoryresponse.md)>**
### Errors
...
(async() => {
  ...
  const res = await sdk.sales.productCategories.list({
...
| ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `request`                                                                                                              | [operations.ListCommerceProductCategoriesRequest](../../sdk/models/operations/listcommerceproductcategoriesrequest.md) | :heavy_check_mark:                                                                                                     | The request object to use for the request.                                                                             |
| `retries`                                                                                                              | [utils.RetryConfig](../../internal/utils/retryconfig.md)                                                               | :heavy_minus_sign:                                                                                                     | Configuration to override the default retry behavior of the client.                                                    |
| `config`                                                                                                               | [AxiosRequestConfig](https://axios-http.com/docs/req_config)                                                           | :heavy_minus_sign:                                                                                                     | Available config options for making requests.                                                                          |
...
**Promise<[operations.ListCommerceProductCategoriesResponse](../../sdk/models/operations/listcommerceproductcategoriesresponse.md)>**
### Errors
