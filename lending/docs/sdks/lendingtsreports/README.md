...
async function run() {
  ...
  const result = await sdk.accountsReceivable.reports.isAgedDebtorsAvailable(companyId);
...
```typescript
import { LendingTs } from "@speakeasy-sdks/lending";
import { RFCDate } from "@speakeasy-sdks/lending/types";
...
async function run() {
  ...
  const result = await sdk.accountsReceivable.reports.getAgedDebtors(companyId, reportDate, numberOfPeriods, periodLengthDays);
...
async function run() {
  ...
  const result = await sdk.accountsReceivable.reports.isAgedCreditorsAvailable(companyId);
...
async function run() {
  ...
  const result = await sdk.accountsReceivable.reports.getAgedCreditors(companyId, reportDate, numberOfPeriods, periodLengthDays);
