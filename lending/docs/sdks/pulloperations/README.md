...
async function run() {
  ...
  const result = await sdk.manageData.pullOperations.list({
...
async function run() {
  ...
  const datasetId = "b18d8d81-fd7b-4764-a31e-475cb1f36591";
  
  const result = await sdk.manageData.pullOperations.get(companyId, datasetId);
