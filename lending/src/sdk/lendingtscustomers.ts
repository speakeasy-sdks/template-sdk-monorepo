...
export class LendingTsCustomers extends ClientSDK {
     ...
     */
    async list(
        input: operations.ListCommerceCustomersRequest,
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) => operations.ListCommerceCustomersRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.ListCommerceCustomersResponse$.inboundSchema.parse({
                        ...responseFields$,
                        CommerceCustomers: val$,
                    });
                },
    ...
    async get(
        ...
        const input$: operations.GetCommerceCustomerRequest = {
            companyId: companyId,
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.GetCommerceCustomerRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetCommerceCustomerResponse$.inboundSchema.parse({
                        ...responseFields$,
                        CommerceCustomer: val$,
                    });
                },
                "Response validation failed"
            );
