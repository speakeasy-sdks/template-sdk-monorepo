...
import { LendingTsAccounts } from "./lendingtsaccounts";
...
export class AccountingBankData extends ClientSDK {
    ...
    private _accounts?: LendingTsAccounts;
    get accounts() {
        return (this._accounts ??= new LendingTsAccounts(this.options$));
    }
    ...
    async listTransactions(
        input: operations.ListAccountingBankAccountTransactionsRequest,
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) =>
                operations.ListAccountingBankAccountTransactionsRequest$.outboundSchema.parse(
                    value$
                ),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.ListAccountingBankAccountTransactionsResponse$.inboundSchema.parse(
                        {
                            ...responseFields$,
                            AccountingBankTransactions: val$,
                        }
                    );
                },
