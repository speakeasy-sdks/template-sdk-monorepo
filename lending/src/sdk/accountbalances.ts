...
export class AccountBalances extends ClientSDK {
     ...
     */
    async list(
        input: operations.ListBankingAccountBalancesRequest,
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) => operations.ListBankingAccountBalancesRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.ListBankingAccountBalancesResponse$.inboundSchema.parse({
                        ...responseFields$,
                        BankingAccountBalances: val$,
                    });
                },
