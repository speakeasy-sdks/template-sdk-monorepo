...
export class LendingTsLoanWritebackPayments extends ClientSDK {
    ...
    async getCreateModel(
        ...
        const input$: operations.GetCreatePaymentModelRequest = {
            companyId: companyId,
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.GetCreatePaymentModelRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetCreatePaymentModelResponse$.inboundSchema.parse({
                        ...responseFields$,
                        PushOption: val$,
                    });
                },
     ...
     */
    async create(
        input: operations.CreatePaymentRequest,
        options?: RequestOptions & { retries?: retries$.RetryConfig }
        ...
        const body$ = enc$.encodeJSON("body", payload$.AccountingPayment, { explode: true });
            ...
            const result = schemas$.parse(
                ...
                (val$) => {
                    return operations.CreatePaymentResponse$.inboundSchema.parse({
                        ...responseFields$,
                        AccountingCreatePaymentResponse: val$,
                    });
                },
                "Response validation failed"
            );
