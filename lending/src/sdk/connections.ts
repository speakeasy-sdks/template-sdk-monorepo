...
export class Connections extends ClientSDK {
    ...
    async create(
        companyId: string,
        requestBody?: operations.CreateConnectionRequestBody | undefined,
        options?: RequestOptions & { retries?: retries$.RetryConfig }
    ): Promise<operations.CreateConnectionResponse> {
        const input$: operations.CreateConnectionRequest = {
            companyId: companyId,
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.CreateConnectionResponse$.inboundSchema.parse({
                        ...responseFields$,
                        Connection: val$,
                    });
                },
    ...
    async get(
        ...
        const input$: operations.GetConnectionRequest = {
            companyId: companyId,
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetConnectionResponse$.inboundSchema.parse({
                        ...responseFields$,
                        Connection: val$,
                    });
                },
    ...
    async delete(
        ...
        const input$: operations.DeleteConnectionRequest = {
            companyId: companyId,
            connectionId: connectionId,
        };
        const headers$ = new Headers();
        ...
        return schemas$.parse(
            undefined,
            () => operations.DeleteConnectionResponse$.inboundSchema.parse(responseFields$),
            "Response validation failed"
        );
    }
    ...
    async unlink(
        companyId: string,
        connectionId: string,
        requestBody?: operations.UnlinkConnectionUpdateConnection | undefined,
        options?: RequestOptions & { retries?: retries$.RetryConfig }
    ): Promise<operations.UnlinkConnectionResponse> {
        const input$: operations.UnlinkConnectionRequest = {
            companyId: companyId,
            connectionId: connectionId,
            requestBody: requestBody,
        };
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.UnlinkConnectionResponse$.inboundSchema.parse({
                        ...responseFields$,
                        Connection: val$,
                    });
                },
