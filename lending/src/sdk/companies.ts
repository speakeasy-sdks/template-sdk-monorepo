...
export class Companies {
    ...
    async delete(
        ...
        const req = new operations.DeleteCompanyRequest({
            companyId: companyId,
        });
        const baseURL: string = utils.templateUrl(
            this.sdkConfiguration.serverURL,
    ...
    async get(
        ...
        const req = new operations.GetCompanyRequest({
            companyId: companyId,
        });
        const baseURL: string = utils.templateUrl(
            this.sdkConfiguration.serverURL,
    ...
    async list(
        ...
        const req = new operations.ListCompaniesRequest({
            orderBy: orderBy,
            page: page,
            pageSize: pageSize,
            query: query,
    ...
    async update(
        ...
        const req = new operations.UpdateCompanyRequest({
            companyId: companyId,
