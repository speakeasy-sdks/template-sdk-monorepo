...
export class LendingLoanWritebackAccounts {
    ...
    async create(
        ...
        try {
            [reqBodyHeaders, reqBody] = utils.serializeRequestBody(req, "accountPrototype", "json");
        } catch (e: unknown) {
    ...
    async getCreateModel(
        ...
        const req = new operations.GetCreateChartOfAccountsModelRequest({
            companyId: companyId,
