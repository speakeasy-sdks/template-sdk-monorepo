...
export class AccountsReceivableInvoices {
    ...
    async downloadAttachment(
        ...
        const req = new operations.DownloadAccountingInvoiceAttachmentRequest({
    ...
    async downloadPdf(
        ...
        const req = new operations.DownloadAccountingInvoicePdfRequest({
            companyId: companyId,
            invoiceId: invoiceId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async get(
        ...
        const req = new operations.GetAccountingInvoiceRequest({
            companyId: companyId,
            invoiceId: invoiceId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async getAttachment(
        ...
        const req = new operations.GetAccountingInvoiceAttachmentRequest({
            attachmentId: attachmentId,
            companyId: companyId,
            connectionId: connectionId,
            invoiceId: invoiceId,
    ...
    async listAttachments(
        ...
        const req = new operations.ListAccountingInvoiceAttachmentsRequest({
            companyId: companyId,
            connectionId: connectionId,
            invoiceId: invoiceId,
        });
    ...
    async listReconciled(
        ...
        const req = new operations.ListReconciledInvoicesRequest({
            companyId: companyId,
            page: page,
            pageSize: pageSize,
            query: query,
