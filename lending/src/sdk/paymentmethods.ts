...
export class PaymentMethods extends ClientSDK {
     ...
     */
    async list(
        input: operations.ListCommercePaymentMethodsRequest,
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) => operations.ListCommercePaymentMethodsRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.ListCommercePaymentMethodsResponse$.inboundSchema.parse({
                        ...responseFields$,
                        CommercePaymentMethods: val$,
                    });
                },
    ...
    async get(
        ...
        const input$: operations.GetCommercePaymentMethodRequest = {
            companyId: companyId,
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.GetCommercePaymentMethodRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetCommercePaymentMethodResponse$.inboundSchema.parse({
                        ...responseFields$,
                        CommercePaymentMethod: val$,
                    });
                },
                "Response validation failed"
            );
