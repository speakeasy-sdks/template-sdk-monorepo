...
export class Reports {
    ...
    async getAgedCreditors(
        ...
        const req = new operations.GetAccountingAgedCreditorsReportRequest({
            companyId: companyId,
    ...
    async getAgedDebtors(
        ...
        const req = new operations.GetAccountingAgedDebtorsReportRequest({
            companyId: companyId,
            numberOfPeriods: numberOfPeriods,
            periodLengthDays: periodLengthDays,
            reportDate: reportDate,
    ...
    async isAgedDebtorsAvailable(
        ...
        const req = new operations.IsAgedDebtorsReportAvailableRequest({
            companyId: companyId,
        });
        const baseURL: string = utils.templateUrl(
            this.sdkConfiguration.serverURL,
