...
export class LendingTsSalesTransactions extends ClientSDK {
     ...
     */
    async list(
        input: operations.ListCommerceTransactionsRequest,
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) => operations.ListCommerceTransactionsRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.ListCommerceTransactionsResponse$.inboundSchema.parse({
                        ...responseFields$,
                        CommerceTransactions: val$,
                    });
                },
    ...
    async get(
        ...
        const input$: operations.GetCommerceTransactionRequest = {
            companyId: companyId,
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.GetCommerceTransactionRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetCommerceTransactionResponse$.inboundSchema.parse({
                        ...responseFields$,
                        CommerceTransaction: val$,
                    });
                },
                "Response validation failed"
            );
