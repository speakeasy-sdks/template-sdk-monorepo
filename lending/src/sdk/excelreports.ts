...
export class ExcelReports {
    ...
    async download(
        ...
        const req = new operations.DownloadExcelReportRequest({
            companyId: companyId,
    ...
    async generate(
        ...
        const req = new operations.GenerateExcelReportRequest({
            companyId: companyId,
            reportType: reportType,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async getStatus(
        ...
        const req = new operations.GetExcelReportGenerationStatusRequest({
            companyId: companyId,
            reportType: reportType,
        });
        const baseURL: string = utils.templateUrl(
