...
export class Products extends ClientSDK {
     ...
     */
    async list(
        input: operations.ListCommerceProductsRequest,
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) => operations.ListCommerceProductsRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.ListCommerceProductsResponse$.inboundSchema.parse({
                        ...responseFields$,
                        CommerceProducts: val$,
                    });
                },
    ...
    async get(
        ...
        const input$: operations.GetCommerceProductRequest = {
            companyId: companyId,
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.GetCommerceProductRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetCommerceProductResponse$.inboundSchema.parse({
                        ...responseFields$,
                        CommerceProduct: val$,
                    });
                },
