...
export class LendingTsBankingAccounts extends ClientSDK {
     ...
     */
    async list(
        input: operations.ListBankingAccountsRequest,
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) => operations.ListBankingAccountsRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.ListBankingAccountsResponse$.inboundSchema.parse({
                        ...responseFields$,
                        BankingAccounts: val$,
                    });
                },
    ...
    async get(
        ...
        const input$: operations.GetBankingAccountRequest = {
            companyId: companyId,
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.GetBankingAccountRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetBankingAccountResponse$.inboundSchema.parse({
                        ...responseFields$,
                        BankingAccount: val$,
                    });
                },
