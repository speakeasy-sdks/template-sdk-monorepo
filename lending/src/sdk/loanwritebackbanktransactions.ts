...
export class LoanWritebackBankTransactions {
        ...
        switch (true) {
            case httpRes?.status == 200:
                if (utils.matchContentType(contentType, `application/json`)) {
                    res.accountingCreateBankTransactionsResponse = utils.objectToClass(
    ...
    async getCreateModel(
        ...
        const req = new operations.GetCreateBankTransactionsModelRequest({
            accountId: accountId,
            companyId: companyId,
