 ...
 */
export class AccountingCreatePaymentResponseAccountingPayment extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata({ elemType: PaymentLine })
    @Expose({ name: "lines" })
    @Type(() => PaymentLine)
    lines?: PaymentLine[];
...
export class AccountingCreatePaymentResponse extends SpeakeasyBase {
    /**
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "data" })
    @Type(() => AccountingCreatePaymentResponseAccountingPayment)
