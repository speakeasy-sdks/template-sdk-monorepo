 ...
 */
export class AccountingCreateDirectCostResponseContactReference extends SpeakeasyBase {
    /**
     * Allowed name of the 'dataType'.
     */
    @SpeakeasyMetadata()
 ...
 */
export class AccountingCreateDirectCostResponseAccountingDirectCost extends SpeakeasyBase {
    /**
     * A customer or supplier associated with the direct cost.
     */
    @SpeakeasyMetadata()
    @Expose({ name: "contactRef" })
    @Type(() => AccountingCreateDirectCostResponseContactReference)
...
export class AccountingCreateDirectCostResponse extends SpeakeasyBase {
    /**
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "data" })
    @Type(() => AccountingCreateDirectCostResponseAccountingDirectCost)
