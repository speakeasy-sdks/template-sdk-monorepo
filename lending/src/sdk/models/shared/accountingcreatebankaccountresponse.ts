 ...
 */
export class AccountingCreateBankAccountResponseAccountingBankAccount extends SpeakeasyBase {
    /**
...
export class AccountingCreateBankAccountResponse extends SpeakeasyBase {
    /**
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "data" })
    @Type(() => AccountingCreateBankAccountResponseAccountingBankAccount)
