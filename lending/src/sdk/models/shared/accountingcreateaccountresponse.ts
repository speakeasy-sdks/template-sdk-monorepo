 ...
 */
export class AccountingCreateAccountResponseValidDataTypeLinks extends SpeakeasyBase {
    /**
 ...
 */
export class AccountingCreateAccountResponseAccountingAccount extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata({ elemType: AccountingCreateAccountResponseValidDataTypeLinks })
    @Expose({ name: "validDatatypeLinks" })
    @Type(() => AccountingCreateAccountResponseValidDataTypeLinks)
...
export class AccountingCreateAccountResponse extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "data" })
    @Type(() => AccountingCreateAccountResponseAccountingAccount)
