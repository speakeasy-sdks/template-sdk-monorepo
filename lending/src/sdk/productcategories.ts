...
export class ProductCategories extends ClientSDK {
     ...
     */
    async list(
        input: operations.ListCommerceProductCategoriesRequest,
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) =>
                operations.ListCommerceProductCategoriesRequest$.outboundSchema.parse(value$),
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.ListCommerceProductCategoriesResponse$.inboundSchema.parse({
                        ...responseFields$,
                        CommerceProductCategories: val$,
                    });
                },
    ...
    async get(
        ...
        const input$: operations.GetCommerceProductCategoryRequest = {
            companyId: companyId,
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) => operations.GetCommerceProductCategoryRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        const pathParams$ = {
            ...
            productId: enc$.encodeSimple("productId", payload$.productId, {
                explode: false,
                charEncoding: "percent",
            }),
        };
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetCommerceProductCategoryResponse$.inboundSchema.parse({
                        ...responseFields$,
                        CommerceProductCategory: val$,
                    });
                },
                "Response validation failed"
            );
