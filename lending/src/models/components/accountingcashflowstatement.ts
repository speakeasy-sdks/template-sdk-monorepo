...
export namespace AccountingCashFlowStatement$ {
    ...
    export const inboundSchema: z.ZodType<AccountingCashFlowStatement, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingCashFlowStatement> = z
        .object({
