...
import { AccountingDirectCost, AccountingDirectCost$ } from "./accountingdirectcost";
...
export namespace AccountingDirectCosts$ {
    export type Inbound = {
        results?: Array<AccountingDirectCost$.Inbound> | undefined;
        pageNumber: number;
        pageSize: number;
        totalResults: number;
    ...
    export const inboundSchema: z.ZodType<AccountingDirectCosts, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingDirectCosts> = z
        .object({
