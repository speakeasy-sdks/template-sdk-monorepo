...
import { AgedCreditor, AgedCreditor$ } from "./agedcreditor";
 ...
 */
export type AccountingAgedCreditorReport = {
    /**
     ...
     */
    data?: Array<AgedCreditor> | undefined;
};

/** @internal */
export namespace AccountingAgedCreditorReport$ {
    export type Inbound = {
        generated?: string | undefined;
        reportDate?: string | undefined;
        data?: Array<AgedCreditor$.Inbound> | undefined;
    };

    export const inboundSchema: z.ZodType<AccountingAgedCreditorReport, z.ZodTypeDef, Inbound> = z
        .object({
        ...
        .transform((v) => {
            return {
                ...(v.generated === undefined ? null : { generated: v.generated }),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingAgedCreditorReport> = z
        .object({
            generated: z.string().optional(),
            reportDate: z.string().optional(),
