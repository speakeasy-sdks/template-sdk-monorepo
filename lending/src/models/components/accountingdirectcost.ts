...
export type ContactReference = {
     ...
     * Allowed name of the 'dataType'.
     */
    dataType?: AccountingDirectCostDataType | null | undefined;
};
...
/** @internal */
export const AccountingDirectCostDataType$ = z.nativeEnum(AccountingDirectCostDataType);
...
export namespace ContactReference$ {
    ...
    export const inboundSchema: z.ZodType<ContactReference, z.ZodTypeDef, Inbound> = z
        .object({
            id: z.string(),
            dataType: z.nullable(AccountingDirectCostDataType$).optional(),
        })
        .transform((v) => {
            return {
                id: v.id,
