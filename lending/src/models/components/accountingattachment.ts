...
export namespace AccountingAttachment$ {
    ...
    export const inboundSchema: z.ZodType<AccountingAttachment, z.ZodTypeDef, Inbound> = z
        .object({
        ...
        .transform((v) => {
            return {
                ...
                ...(v.dateCreated === undefined ? null : { dateCreated: v.dateCreated }),
                ...(v.fileSize === undefined ? null : { fileSize: v.fileSize }),
                ...(v.includeWhenSent === undefined
                    ? null
                    : { includeWhenSent: v.includeWhenSent }),
            };
        });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingAttachment> = z
        .object({
            modifiedDate: z.string().optional(),
            sourceModifiedDate: z.string().optional(),
            id: z.string().optional(),
