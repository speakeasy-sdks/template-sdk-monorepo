...
import { AgedDebtor, AgedDebtor$ } from "./ageddebtor";
 ...
 */
export type AccountingAgedDebtorReport = {
    /**
     ...
     */
    data?: Array<AgedDebtor> | undefined;
};

/** @internal */
export namespace AccountingAgedDebtorReport$ {
    export type Inbound = {
        generated?: string | undefined;
        reportDate?: string | undefined;
        data?: Array<AgedDebtor$.Inbound> | undefined;
    };

    export const inboundSchema: z.ZodType<AccountingAgedDebtorReport, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingAgedDebtorReport> = z
        .object({
            generated: z.string().optional(),
            reportDate: z.string().optional(),
