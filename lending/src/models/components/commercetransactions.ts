...
import { CommerceTransaction, CommerceTransaction$ } from "./commercetransaction";
...
export namespace CommerceTransactions$ {
    export type Inbound = {
        results?: Array<CommerceTransaction$.Inbound> | undefined;
        pageNumber: number;
        pageSize: number;
        totalResults: number;
    ...
    export const inboundSchema: z.ZodType<CommerceTransactions, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CommerceTransactions> = z
        .object({
