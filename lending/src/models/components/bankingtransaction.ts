...
import { TransactionCategoryRef, TransactionCategoryRef$ } from "./transactioncategoryref";
import { TransactionCode, TransactionCode$ } from "./transactioncode";
...
export namespace BankingTransaction$ {
    export type Inbound = {
        ...
        code?: TransactionCode | undefined;
        merchantName?: string | null | undefined;
        transactionCategoryRef?: TransactionCategoryRef$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<BankingTransaction, z.ZodTypeDef, Inbound> = z
        .object({
        ...
        .transform((v) => {
            return {
                ...
                currency: v.currency,
                ...(v.postedDate === undefined ? null : { postedDate: v.postedDate }),
                ...(v.authorizedDate === undefined ? null : { authorizedDate: v.authorizedDate }),
                ...(v.code === undefined ? null : { code: v.code }),
                ...(v.merchantName === undefined ? null : { merchantName: v.merchantName }),
                ...(v.transactionCategoryRef === undefined
                    ? null
                    : { transactionCategoryRef: v.transactionCategoryRef }),
            };
        });
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BankingTransaction> = z
        .object({
            modifiedDate: z.string().optional(),
            sourceModifiedDate: z.string().optional(),
            id: z.string(),
