...
/** @internal */
export namespace PaymentAllocationPayment$ {
    export type Inbound = {
        id?: string | undefined;
        note?: string | null | undefined;
        reference?: string | null | undefined;
    ...
    export const inboundSchema: z.ZodType<PaymentAllocationPayment, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PaymentAllocationPayment> = z
        .object({
            id: z.string().optional(),
            note: z.nullable(z.string()).optional(),
            reference: z.nullable(z.string()).optional(),
