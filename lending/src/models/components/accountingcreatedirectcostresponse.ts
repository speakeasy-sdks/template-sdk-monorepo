 ...
 */
export enum AccountingCreateDirectCostResponseDataType {
    Customers = "customers",
    Suppliers = "suppliers",
}
 ...
 */
export type AccountingCreateDirectCostResponseContactReference = {
    /**
     ...
     * Allowed name of the 'dataType'.
     */
    dataType?: AccountingCreateDirectCostResponseDataType | null | undefined;
};
...
export type AccountingCreateDirectCostResponseAccountingDirectCost = {
     ...
     * A customer or supplier associated with the direct cost.
     */
    contactRef?: AccountingCreateDirectCostResponseContactReference | undefined;
    /**
...
export type AccountingCreateDirectCostResponse = {
    data?: AccountingCreateDirectCostResponseAccountingDirectCost | null | undefined;
    /**
...
/** @internal */
export const AccountingCreateDirectCostResponseDataType$ = z.nativeEnum(
    AccountingCreateDirectCostResponseDataType
);

/** @internal */
export namespace AccountingCreateDirectCostResponseContactReference$ {
    export type Inbound = {
        id: string;
        dataType?: AccountingCreateDirectCostResponseDataType | null | undefined;
    };
    ...
    > = z
        .object({
            id: z.string(),
            dataType: z.nullable(AccountingCreateDirectCostResponseDataType$).optional(),
        })
        .transform((v) => {
            return {
                id: v.id,
...
export namespace AccountingCreateDirectCostResponseAccountingDirectCost$ {
    export type Inbound = {
        ...
        reference?: string | null | undefined;
        note?: string | null | undefined;
        contactRef?: AccountingCreateDirectCostResponseContactReference$.Inbound | undefined;
        issueDate: string;
        currency: string;
    ...
    > = z
        .object({
            ...
            contactRef: z
                .lazy(() => AccountingCreateDirectCostResponseContactReference$.inboundSchema)
                .optional(),
            issueDate: z.string(),
            currency: z.string(),
    ...
    export type Outbound = {
        ...
        reference?: string | null | undefined;
        note?: string | null | undefined;
        contactRef?: AccountingCreateDirectCostResponseContactReference$.Outbound | undefined;
        issueDate: string;
        currency: string;
        currencyRate?: number | null | undefined;
    ...
    > = z
        .object({
            ...
            note: z.nullable(z.string()).optional(),
            contactRef: z
                .lazy(() => AccountingCreateDirectCostResponseContactReference$.outboundSchema)
                .optional(),
            issueDate: z.string(),
            currency: z.string(),
            currencyRate: z
...
export namespace AccountingCreateDirectCostResponse$ {
    export type Inbound = {
        data?: AccountingCreateDirectCostResponseAccountingDirectCost$.Inbound | null | undefined;
    ...
    export type Outbound = {
        data?: AccountingCreateDirectCostResponseAccountingDirectCost$.Outbound | null | undefined;
