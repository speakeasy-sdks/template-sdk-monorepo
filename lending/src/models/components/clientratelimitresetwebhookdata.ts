...
export namespace ClientRateLimitResetWebhookData$ {
    ...
    export const inboundSchema: z.ZodType<ClientRateLimitResetWebhookData, z.ZodTypeDef, Inbound> =
        z
            .object({
            ...
            .transform((v) => {
                return {
                    ...
                    ...(v.ResetReason === undefined ? null : { resetReason: v.ResetReason }),
    ...
    > = z
        ...
        .transform((v) => {
            return {
                ...(v.quotaRemaining === undefined ? null : { QuotaRemaining: v.quotaRemaining }),
                ...(v.resetReason === undefined ? null : { ResetReason: v.resetReason }),
                ...(v.dailyQuota === undefined ? null : { DailyQuota: v.dailyQuota }),
                ...(v.expiresUtc === undefined ? null : { ExpiresUtc: v.expiresUtc }),
            };
