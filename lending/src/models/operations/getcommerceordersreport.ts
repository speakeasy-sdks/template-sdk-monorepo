...
export type GetCommerceOrdersReportResponse = {
...
export namespace GetCommerceOrdersReportRequest$ {
    ...
    export const inboundSchema: z.ZodType<GetCommerceOrdersReportRequest, z.ZodTypeDef, Inbound> = z
        .object({
            companyId: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCommerceOrdersReportRequest> =
        z
            .object({
                companyId: z.string(),
                connectionId: z.string(),
...
/** @internal */
export namespace GetCommerceOrdersReportResponse$ {
    export type Inbound = {
        HttpMeta: components.HTTPMetadata$.Inbound;
        CommerceReport?: components.CommerceReport$.Inbound | undefined;
    };

    export const inboundSchema: z.ZodType<GetCommerceOrdersReportResponse, z.ZodTypeDef, Inbound> =
        z
            .object({
            ...
            .transform((v) => {
                return {
                    httpMeta: v.HttpMeta,
                    ...(v.CommerceReport === undefined
                        ? null
                        : { commerceReport: v.CommerceReport }),
                };
            });
