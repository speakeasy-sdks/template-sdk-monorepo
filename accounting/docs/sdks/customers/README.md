...
import { AccountingAddressType, CustomerStatus, PhoneNumberType } from "@speakeasy-sdks/accounting/sdk/models/shared";
...
async function run() {
  ...
  const timeoutInMinutes = 796474;
  
  const result = await sdk.customers.create(companyId, connectionId, customer, timeoutInMinutes);
...
async function run() {
  ...
  const result = await sdk.customers.downloadAttachment(attachmentId, companyId, connectionId, customerId);
...
async function run() {
  ...
  const result = await sdk.customers.get(companyId, customerId);
...
async function run() {
  ...
  const result = await sdk.customers.getAttachment(attachmentId, companyId, connectionId, customerId);
...
async function run() {
  ...
  const result = await sdk.customers.getCreateUpdateModel(companyId, connectionId);
...
async function run() {
  ...
  const result = await sdk.customers.listAttachments(companyId, connectionId, customerId);
