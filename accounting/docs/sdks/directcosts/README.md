...
import { TrackingRecordRefDataType } from "@speakeasy-sdks/accounting/sdk/models/shared";
...
async function run() {
    ...
    lineItems: [
      {
        ...
        unitAmount: new Decimal("4174.58"),
      },
    ],
    paymentAllocations: [
      {
  ...
  const timeoutInMinutes = 951062;
  
  const result = await sdk.directCosts.create(companyId, connectionId, directCostPrototype, timeoutInMinutes);
...
async function run() {
  ...
  const result = await sdk.directCosts.delete(companyId, connectionId, directCostId);
...
async function run() {
  ...
  const result = await sdk.directCosts.downloadAttachment(attachmentId, companyId, connectionId, directCostId);
...
async function run() {
  ...
  const result = await sdk.directCosts.get(companyId, connectionId, directCostId);
...
async function run() {
  ...
  const result = await sdk.directCosts.getAttachment(attachmentId, companyId, connectionId, directCostId);
...
async function run() {
  ...
  const result = await sdk.directCosts.getCreateModel(companyId, connectionId);
...
async function run() {
  ...
  const result = await sdk.directCosts.list({
...
async function run() {
  ...
  const result = await sdk.directCosts.listAttachments(companyId, connectionId, directCostId);
...
async function run() {
  ...
  const result = await sdk.directCosts.uploadAttachment(companyId, connectionId, directCostId, attachmentUpload);
