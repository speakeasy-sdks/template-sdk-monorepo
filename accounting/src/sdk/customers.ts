...
export class Customers {
    ...
    async create(
        ...
        const req = new operations.CreateCustomerRequest({
            companyId: companyId,
    ...
    async downloadAttachment(
        ...
        const req = new operations.DownloadCustomerAttachmentRequest({
    ...
    async getAttachment(
        ...
        const req = new operations.GetCustomerAttachmentRequest({
            attachmentId: attachmentId,
            companyId: companyId,
            connectionId: connectionId,
            customerId: customerId,
    ...
    async getCreateUpdateModel(
        ...
        const req = new operations.GetCreateUpdateCustomersModelRequest({
            companyId: companyId,
            connectionId: connectionId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async listAttachments(
        ...
        const req = new operations.ListCustomerAttachmentsRequest({
            companyId: companyId,
            connectionId: connectionId,
            customerId: customerId,
        });
