...
export class DirectIncomes {
    ...
    async create(
        ...
        const req = new operations.CreateDirectIncomeRequest({
            companyId: companyId,
    ...
    async downloadAttachment(
        ...
        const req = new operations.DownloadDirectIncomeAttachmentRequest({
    ...
    async get(
        ...
        const req = new operations.GetDirectIncomeRequest({
            companyId: companyId,
            connectionId: connectionId,
            directIncomeId: directIncomeId,
        });
    ...
    async getCreateModel(
        ...
        const req = new operations.GetCreateDirectIncomesModelRequest({
            companyId: companyId,
            connectionId: connectionId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async listAttachments(
        ...
        const req = new operations.ListDirectIncomeAttachmentsRequest({
            companyId: companyId,
            connectionId: connectionId,
            directIncomeId: directIncomeId,
        });
    ...
    async uploadAttachment(
        ...
        const req = new operations.UploadDirectIncomeAttachmentRequest({
            companyId: companyId,
            connectionId: connectionId,
            directIncomeId: directIncomeId,
