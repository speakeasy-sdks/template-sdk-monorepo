...
export class BillPayments {
    ...
    async delete(
        ...
        const req = new operations.DeleteBillPaymentRequest({
    ...
    async get(
        ...
        const req = new operations.GetBillPaymentsRequest({
            billPaymentId: billPaymentId,
            companyId: companyId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async getCreateModel(
        ...
        const req = new operations.GetCreateBillPaymentsModelRequest({
            companyId: companyId,
            connectionId: connectionId,
        });
        const baseURL: string = utils.templateUrl(
