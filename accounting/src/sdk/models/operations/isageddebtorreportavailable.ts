...
export type IsAgedDebtorReportAvailableRequest = {
    /**
...
export type IsAgedDebtorReportAvailableResponse = {
    /**
...
/** @internal */
export namespace IsAgedDebtorReportAvailableRequest$ {
    export type Inbound = {
        companyId: string;
    };
...
/** @internal */
export namespace IsAgedDebtorReportAvailableResponse$ {
    export type Inbound = {
        ContentType: string;
