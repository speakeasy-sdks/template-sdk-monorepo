...
export type GetCreateDirectIncomesModelRequest = {
    /**
...
export type GetCreateDirectIncomesModelResponse = {
    /**
...
/** @internal */
export namespace GetCreateDirectIncomesModelRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
    };
...
/** @internal */
export namespace GetCreateDirectIncomesModelResponse$ {
    export type Inbound = {
        ContentType: string;
