...
export type GetCreateUpdateBillsModelRequest = {
    /**
...
export type GetCreateUpdateBillsModelResponse = {
    /**
...
/** @internal */
export namespace GetCreateUpdateBillsModelRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
    };

    export const inboundSchema: z.ZodType<GetCreateUpdateBillsModelRequest, z.ZodTypeDef, Inbound> =
        z
            .object({
                companyId: z.string(),
...
/** @internal */
export namespace GetCreateUpdateBillsModelResponse$ {
    export type Inbound = {
        ContentType: string;
