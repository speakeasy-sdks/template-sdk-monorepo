...
export type GetCreateJournalsModelRequest = {
    /**
...
export type GetCreateJournalsModelResponse = {
    /**
...
/** @internal */
export namespace GetCreateJournalsModelRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
    };

    export const inboundSchema: z.ZodType<GetCreateJournalsModelRequest, z.ZodTypeDef, Inbound> = z
        .object({
            companyId: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreateJournalsModelRequest> =
        z
            .object({
                companyId: z.string(),
                connectionId: z.string(),
...
/** @internal */
export namespace GetCreateJournalsModelResponse$ {
    export type Inbound = {
        ContentType: string;
    ...
    export const inboundSchema: z.ZodType<GetCreateJournalsModelResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreateJournalsModelResponse> =
        z
            .object({
                contentType: z.string(),
