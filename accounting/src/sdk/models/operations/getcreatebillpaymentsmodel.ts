...
export type GetCreateBillPaymentsModelRequest = {
    /**
...
export type GetCreateBillPaymentsModelResponse = {
    /**
...
/** @internal */
export namespace GetCreateBillPaymentsModelRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
    };
...
/** @internal */
export namespace GetCreateBillPaymentsModelResponse$ {
    export type Inbound = {
        ContentType: string;
