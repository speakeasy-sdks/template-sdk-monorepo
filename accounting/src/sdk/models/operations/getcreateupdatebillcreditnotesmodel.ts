...
export type GetCreateUpdateBillCreditNotesModelRequest = {
    /**
...
export type GetCreateUpdateBillCreditNotesModelResponse = {
    /**
...
/** @internal */
export namespace GetCreateUpdateBillCreditNotesModelRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
    };
...
/** @internal */
export namespace GetCreateUpdateBillCreditNotesModelResponse$ {
    export type Inbound = {
        ContentType: string;
