...
export type GetCreatePaymentsModelRequest = {
    /**
...
export type GetCreatePaymentsModelResponse = {
    /**
...
/** @internal */
export namespace GetCreatePaymentsModelRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
    };

    export const inboundSchema: z.ZodType<GetCreatePaymentsModelRequest, z.ZodTypeDef, Inbound> = z
        .object({
            companyId: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreatePaymentsModelRequest> =
        z
            .object({
                companyId: z.string(),
                connectionId: z.string(),
...
/** @internal */
export namespace GetCreatePaymentsModelResponse$ {
    export type Inbound = {
        ContentType: string;
    ...
    export const inboundSchema: z.ZodType<GetCreatePaymentsModelResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreatePaymentsModelResponse> =
        z
            .object({
                contentType: z.string(),
