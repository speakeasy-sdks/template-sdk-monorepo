...
export type UploadTransferAttachmentRequest = {
    /**
...
export type UploadTransferAttachmentResponse = {
    /**
...
/** @internal */
export namespace UploadTransferAttachmentRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
        transferId: string;
    ...
    export const inboundSchema: z.ZodType<UploadTransferAttachmentRequest, z.ZodTypeDef, Inbound> =
        z
            .object({
                companyId: z.string(),
...
/** @internal */
export namespace UploadTransferAttachmentResponse$ {
    export type Inbound = {
        ContentType: string;
    ...
    export const inboundSchema: z.ZodType<UploadTransferAttachmentResponse, z.ZodTypeDef, Inbound> =
        z
            .object({
