...
export type GetCreateUpdateInvoicesModelRequest = {
    /**
...
export type GetCreateUpdateInvoicesModelResponse = {
    /**
...
/** @internal */
export namespace GetCreateUpdateInvoicesModelRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
    };
...
/** @internal */
export namespace GetCreateUpdateInvoicesModelResponse$ {
    export type Inbound = {
        ContentType: string;
