...
export type GetCreateItemsModelRequest = {
    /**
...
export type GetCreateItemsModelResponse = {
    /**
...
/** @internal */
export namespace GetCreateItemsModelRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
    };

    export const inboundSchema: z.ZodType<GetCreateItemsModelRequest, z.ZodTypeDef, Inbound> = z
        .object({
            companyId: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreateItemsModelRequest> = z
        .object({
            companyId: z.string(),
            connectionId: z.string(),
        })
...
/** @internal */
export namespace GetCreateItemsModelResponse$ {
    export type Inbound = {
        ContentType: string;
    ...
    export const inboundSchema: z.ZodType<GetCreateItemsModelResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetCreateItemsModelResponse> = z
        .object({
            contentType: z.string(),
