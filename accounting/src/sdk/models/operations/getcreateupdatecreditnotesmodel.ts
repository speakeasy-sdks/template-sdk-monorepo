...
export type GetCreateUpdateCreditNotesModelRequest = {
    /**
...
export type GetCreateUpdateCreditNotesModelResponse = {
    /**
...
/** @internal */
export namespace GetCreateUpdateCreditNotesModelRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
    };
...
/** @internal */
export namespace GetCreateUpdateCreditNotesModelResponse$ {
    export type Inbound = {
        ContentType: string;
