...
export type ListItemsResponse = {
     ...
     * Success
     */
    items?: shared.SchemaItems | undefined;
    /**
...
export namespace ListItemsRequest$ {
    ...
    export const inboundSchema: z.ZodType<ListItemsRequest, z.ZodTypeDef, Inbound> = z
        .object({
            companyId: z.string(),
...
export namespace ListItemsResponse$ {
    export type Inbound = {
        ...
        Items?: shared.SchemaItems$.Inbound | undefined;
        StatusCode: number;
        RawResponse: Response;
    };

    export const inboundSchema: z.ZodType<ListItemsResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ContentType: z.string(),
            ErrorMessage: shared.ErrorMessage$.inboundSchema.optional(),
            Items: shared.SchemaItems$.inboundSchema.optional(),
    ...
    export type Outbound = {
        ...
        Items?: shared.SchemaItems$.Outbound | undefined;
        StatusCode: number;
        RawResponse: never;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ListItemsResponse> = z
        .object({
            ...
            items: shared.SchemaItems$.outboundSchema.optional(),
            statusCode: z.number().int(),
