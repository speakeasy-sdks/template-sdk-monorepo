...
export type GetCreateJournalEntriesModelRequest = {
    /**
...
export type GetCreateJournalEntriesModelResponse = {
    /**
...
/** @internal */
export namespace GetCreateJournalEntriesModelRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
    };
...
/** @internal */
export namespace GetCreateJournalEntriesModelResponse$ {
    export type Inbound = {
        ContentType: string;
