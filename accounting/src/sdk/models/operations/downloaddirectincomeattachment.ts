...
export type DownloadDirectIncomeAttachmentRequest = {
    /**
...
export type DownloadDirectIncomeAttachmentResponse = {
    /**
...
/** @internal */
export namespace DownloadDirectIncomeAttachmentRequest$ {
    export type Inbound = {
        attachmentId: string;
        companyId: string;
        connectionId: string;
...
/** @internal */
export namespace DownloadDirectIncomeAttachmentResponse$ {
    export type Inbound = {
        ContentType: string;
        Data?: ReadableStream<Uint8Array> | undefined;
