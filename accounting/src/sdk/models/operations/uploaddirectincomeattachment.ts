...
export type UploadDirectIncomeAttachmentRequest = {
    /**
...
export type UploadDirectIncomeAttachmentResponse = {
    /**
...
/** @internal */
export namespace UploadDirectIncomeAttachmentRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
        directIncomeId: string;
...
/** @internal */
export namespace UploadDirectIncomeAttachmentResponse$ {
    export type Inbound = {
        ContentType: string;
