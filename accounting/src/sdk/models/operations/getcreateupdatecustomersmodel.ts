...
export type GetCreateUpdateCustomersModelRequest = {
    /**
...
export type GetCreateUpdateCustomersModelResponse = {
    /**
...
/** @internal */
export namespace GetCreateUpdateCustomersModelRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
    };
...
/** @internal */
export namespace GetCreateUpdateCustomersModelResponse$ {
    export type Inbound = {
        ContentType: string;
