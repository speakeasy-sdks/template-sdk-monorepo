...
export type GetCreateUpdatePurchaseOrdersModelRequest = {
    /**
...
export type GetCreateUpdatePurchaseOrdersModelResponse = {
    /**
...
/** @internal */
export namespace GetCreateUpdatePurchaseOrdersModelRequest$ {
    export type Inbound = {
        companyId: string;
        connectionId: string;
    };
...
/** @internal */
export namespace GetCreateUpdatePurchaseOrdersModelResponse$ {
    export type Inbound = {
        ContentType: string;
