 ...
 */
export class UpdateCreditNoteResponseAccountingCreditNote extends SpeakeasyBase {
    /**
...
export class UpdateCreditNoteResponse extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "data" })
    @Type(() => UpdateCreditNoteResponseAccountingCreditNote)
    data?: UpdateCreditNoteResponseAccountingCreditNote;
