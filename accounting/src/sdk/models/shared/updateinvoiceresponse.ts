 ...
 */
export type UpdateInvoiceResponseAccountingInvoice = {
    /**
...
export type UpdateInvoiceResponse = {
    ...
    data?: UpdateInvoiceResponseAccountingInvoice | null | undefined;
    /**
...
/** @internal */
export namespace UpdateInvoiceResponseAccountingInvoice$ {
    export type Inbound = {
...
export namespace UpdateInvoiceResponse$ {
    export type Inbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: UpdateInvoiceResponseAccountingInvoice$.Inbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const inboundSchema: z.ZodType<UpdateInvoiceResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            data: z
                .nullable(z.lazy(() => UpdateInvoiceResponseAccountingInvoice$.inboundSchema))
                .optional(),
    ...
    export type Outbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: UpdateInvoiceResponseAccountingInvoice$.Outbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpdateInvoiceResponse> = z
        .object({
            ...
            completedOnUtc: z.string().optional(),
            data: z
                .nullable(z.lazy(() => UpdateInvoiceResponseAccountingInvoice$.outboundSchema))
                .optional(),
            dataConnectionKey: z.string(),
            dataType: DataType$.optional(),
            errorMessage: z.nullable(z.string()).optional(),
