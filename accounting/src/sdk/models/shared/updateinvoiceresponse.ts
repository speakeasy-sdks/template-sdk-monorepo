 ...
 */
export class UpdateInvoiceResponseAccountingInvoice extends SpeakeasyBase {
    /**
...
export class UpdateInvoiceResponse extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "data" })
    @Type(() => UpdateInvoiceResponseAccountingInvoice)
    data?: UpdateInvoiceResponseAccountingInvoice;
