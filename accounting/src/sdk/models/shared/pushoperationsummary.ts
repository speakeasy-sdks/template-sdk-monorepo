...
export type PushOperationSummary = {
    /**
...
/** @internal */
export namespace PushOperationSummary$ {
    export type Inbound = {
    ...
    export const inboundSchema: z.ZodType<PushOperationSummary, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PushOperationSummary> = z
        .object({
