...
import { PaymentLine, PaymentLine$ } from "./paymentline";
...
export type CreatePaymentResponse = {
    ...
    data?: AccountingPayment | null | undefined;
    /**
...
/** @internal */
export namespace AccountingPayment$ {
    export type Inbound = {
        ...
        date: string;
        id?: string | undefined;
        lines?: Array<PaymentLine$.Inbound> | null | undefined;
    ...
    export const inboundSchema: z.ZodType<AccountingPayment, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingPayment> = z
        .object({
...
export namespace CreatePaymentResponse$ {
    export type Inbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: AccountingPayment$.Inbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const inboundSchema: z.ZodType<CreatePaymentResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            data: z.nullable(z.lazy(() => AccountingPayment$.inboundSchema)).optional(),
    ...
    export type Outbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: AccountingPayment$.Outbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreatePaymentResponse> = z
        .object({
            ...
            companyId: z.string(),
            completedOnUtc: z.string().optional(),
            data: z.nullable(z.lazy(() => AccountingPayment$.outboundSchema)).optional(),
            dataConnectionKey: z.string(),
            dataType: DataType$.optional(),
            errorMessage: z.nullable(z.string()).optional(),
            pushOperationKey: z.string(),
