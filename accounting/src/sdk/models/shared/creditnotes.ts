...
import { CreditNote, CreditNote$ } from "./creditnote";
...
export type CreditNotes = {
     ...
     */
    pageSize: number;
    results?: Array<CreditNote> | undefined;
    /**
...
export namespace CreditNotes$ {
    export type Inbound = {
        ...
        pageNumber: number;
        pageSize: number;
        results?: Array<CreditNote$.Inbound> | undefined;
        totalResults: number;
    };
    ...
    export const inboundSchema: z.ZodType<CreditNotes, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            results: z.array(CreditNote$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        pageNumber: number;
        pageSize: number;
        results?: Array<CreditNote$.Outbound> | undefined;
        totalResults: number;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreditNotes> = z
        .object({
            ...
            pageNumber: z.number().int(),
            pageSize: z.number().int(),
            results: z.array(CreditNote$.outboundSchema).optional(),
            totalResults: z.number().int(),
        })
        .transform((v) => {
            return {
