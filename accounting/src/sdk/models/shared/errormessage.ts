...
export namespace ErrorMessage$ {
    export const inboundSchema: z.ZodType<ErrorMessage, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ErrorMessage> = z.object({
        canBeRetried: z.string().optional(),
        correlationId: z.string().optional(),
        detailedErrorCode: z.number().int().optional(),
        error: z.string().optional(),
