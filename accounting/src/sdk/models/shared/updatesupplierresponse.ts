 ...
 */
export class UpdateSupplierResponseAccountingSupplier extends SpeakeasyBase {
    /**
...
export class UpdateSupplierResponse extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "data" })
    @Type(() => UpdateSupplierResponseAccountingSupplier)
    data?: UpdateSupplierResponseAccountingSupplier;
