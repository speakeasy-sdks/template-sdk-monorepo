...
/** @internal */
export namespace UpdateSupplierResponseAccountingSupplier$ {
    export type Inbound = {
...
export namespace UpdateSupplierResponse$ {
    export type Inbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: UpdateSupplierResponseAccountingSupplier$.Inbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const inboundSchema: z.ZodType<UpdateSupplierResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            data: z
                .nullable(z.lazy(() => UpdateSupplierResponseAccountingSupplier$.inboundSchema))
                .optional(),
    ...
    export type Outbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: UpdateSupplierResponseAccountingSupplier$.Outbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpdateSupplierResponse> = z
        .object({
            ...
            completedOnUtc: z.string().optional(),
            data: z
                .nullable(z.lazy(() => UpdateSupplierResponseAccountingSupplier$.outboundSchema))
                .optional(),
            dataConnectionKey: z.string(),
            dataType: DataType$.optional(),
            errorMessage: z.nullable(z.string()).optional(),
