 ...
 */
export type UpdatePurchaseOrderResponseUser = {
    /**
 ...
 */
export type UpdatePurchaseOrderResponseAccountingPurchaseOrder = {
    /**
     * The user who created the purchase order in the accounting system
     */
    createdBy?: UpdatePurchaseOrderResponseUser | undefined;
    /**
...
export type UpdatePurchaseOrderResponse = {
    ...
    data?: UpdatePurchaseOrderResponseAccountingPurchaseOrder | null | undefined;
    /**
...
/** @internal */
export namespace UpdatePurchaseOrderResponseUser$ {
    export type Inbound = {
        email?: string | null | undefined;
        firstName?: string | null | undefined;
        lastName?: string | null | undefined;
    ...
    export const inboundSchema: z.ZodType<UpdatePurchaseOrderResponseUser, z.ZodTypeDef, Inbound> =
        z
            .object({
...
/** @internal */
export namespace UpdatePurchaseOrderResponseAccountingPurchaseOrder$ {
    export type Inbound = {
        createdBy?: UpdatePurchaseOrderResponseUser$.Inbound | undefined;
        currency?: string | undefined;
    ...
    > = z
        .object({
            createdBy: z.lazy(() => UpdatePurchaseOrderResponseUser$.inboundSchema).optional(),
    ...
    export type Outbound = {
        createdBy?: UpdatePurchaseOrderResponseUser$.Outbound | undefined;
        currency?: string | undefined;
        currencyRate?: number | null | undefined;
        deliveryDate?: string | undefined;
        expectedDeliveryDate?: string | undefined;
    ...
    > = z
        .object({
            createdBy: z.lazy(() => UpdatePurchaseOrderResponseUser$.outboundSchema).optional(),
            currency: z.string().optional(),
            currencyRate: z
                .nullable(
                    z
...
export namespace UpdatePurchaseOrderResponse$ {
    export type Inbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: UpdatePurchaseOrderResponseAccountingPurchaseOrder$.Inbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const inboundSchema: z.ZodType<UpdatePurchaseOrderResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            data: z
                .nullable(
                    z.lazy(() => UpdatePurchaseOrderResponseAccountingPurchaseOrder$.inboundSchema)
                )
                .optional(),
    ...
    export type Outbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: UpdatePurchaseOrderResponseAccountingPurchaseOrder$.Outbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpdatePurchaseOrderResponse> = z
        .object({
            ...
            data: z
                .nullable(
                    z.lazy(() => UpdatePurchaseOrderResponseAccountingPurchaseOrder$.outboundSchema)
                )
                .optional(),
            dataConnectionKey: z.string(),
            dataType: DataType$.optional(),
