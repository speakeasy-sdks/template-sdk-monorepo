 ...
 */
export type UpdateBankAccountResponseAccountingBankAccount = {
    /**
     ...
     * For Debit accounts, positive balances are assets, and positive transactions **increase** assets.
     */
    accountType?: UpdateBankAccountResponseBankAccountType | undefined;
    /**
...
export type UpdateBankAccountResponse = {
    ...
    data?: UpdateBankAccountResponseAccountingBankAccount | null | undefined;
    /**
...
/** @internal */
export const UpdateBankAccountResponseBankAccountType$ = z.nativeEnum(
    UpdateBankAccountResponseBankAccountType
);

/** @internal */
export namespace UpdateBankAccountResponseAccountingBankAccount$ {
    export type Inbound = {
        accountName?: string | null | undefined;
        accountNumber?: string | null | undefined;
        accountType?: UpdateBankAccountResponseBankAccountType | undefined;
    ...
    > = z
        .object({
            ...
            accountType: UpdateBankAccountResponseBankAccountType$.optional(),
...
export namespace UpdateBankAccountResponse$ {
    export type Inbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: UpdateBankAccountResponseAccountingBankAccount$.Inbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const inboundSchema: z.ZodType<UpdateBankAccountResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            data: z
                .nullable(
                    z.lazy(() => UpdateBankAccountResponseAccountingBankAccount$.inboundSchema)
                )
                .optional(),
    ...
    export type Outbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: UpdateBankAccountResponseAccountingBankAccount$.Outbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpdateBankAccountResponse> = z
        .object({
            ...
            data: z
                .nullable(
                    z.lazy(() => UpdateBankAccountResponseAccountingBankAccount$.outboundSchema)
                )
                .optional(),
            dataConnectionKey: z.string(),
            dataType: DataType$.optional(),
