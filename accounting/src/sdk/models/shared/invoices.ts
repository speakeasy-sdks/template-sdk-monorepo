...
export type Invoices = {
     ...
     */
    pageSize: number;
    results?: Array<Invoice> | undefined;
    /**
...
export namespace Invoices$ {
    export type Inbound = {
        ...
        pageNumber: number;
        pageSize: number;
        results?: Array<Invoice$.Inbound> | undefined;
        totalResults: number;
    };
    ...
    export const inboundSchema: z.ZodType<Invoices, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            results: z.array(Invoice$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        pageNumber: number;
        pageSize: number;
        results?: Array<Invoice$.Outbound> | undefined;
        totalResults: number;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, Invoices> = z
        .object({
            ...
            pageNumber: z.number().int(),
            pageSize: z.number().int(),
            results: z.array(Invoice$.outboundSchema).optional(),
            totalResults: z.number().int(),
        })
        .transform((v) => {
            return {
