...
export class UpdateBillResponseWithholdingTax extends SpeakeasyBase {
    /**
 ...
 */
export class UpdateBillResponseAccountingBill extends SpeakeasyBase {
    /**
    ...
    @SpeakeasyMetadata({ elemType: UpdateBillResponseWithholdingTax })
    @Expose({ name: "withholdingTax" })
    @Type(() => UpdateBillResponseWithholdingTax)
    withholdingTax?: UpdateBillResponseWithholdingTax[];
}
...
export class UpdateBillResponse extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "data" })
    @Type(() => UpdateBillResponseAccountingBill)
    data?: UpdateBillResponseAccountingBill;
