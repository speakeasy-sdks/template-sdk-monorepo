 ...
 */
export type AgedCreditorReport = {
    /**
...
/** @internal */
export namespace AgedCreditorReport$ {
    export type Inbound = {
    ...
    export const inboundSchema: z.ZodType<AgedCreditorReport, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AgedCreditorReport> = z
        .object({
