...
export type CreateSupplierResponse = {
    ...
    data?: AccountingSupplier | null | undefined;
    /**
...
export namespace CreateSupplierResponse$ {
    export type Inbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: AccountingSupplier$.Inbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const inboundSchema: z.ZodType<CreateSupplierResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            data: z.nullable(z.lazy(() => AccountingSupplier$.inboundSchema)).optional(),
    ...
    export type Outbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: AccountingSupplier$.Outbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateSupplierResponse> = z
        .object({
            ...
            companyId: z.string(),
            completedOnUtc: z.string().optional(),
            data: z.nullable(z.lazy(() => AccountingSupplier$.outboundSchema)).optional(),
            dataConnectionKey: z.string(),
            dataType: DataType$.optional(),
            errorMessage: z.nullable(z.string()).optional(),
            pushOperationKey: z.string(),
