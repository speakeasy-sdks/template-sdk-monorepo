...
export namespace CreateBankTransactions$ {
    ...
    export const inboundSchema: z.ZodType<CreateBankTransactions, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateBankTransactions> = z
        .object({
            accountId: z.string().optional(),
