 ...
 */
export class CreatePurchaseOrderResponseUser extends SpeakeasyBase {
    /**
 ...
 */
export class AccountingPurchaseOrder extends SpeakeasyBase {
    /**
     * The user who created the purchase order in the accounting system
     */
    @SpeakeasyMetadata()
    @Expose({ name: "createdBy" })
    @Type(() => CreatePurchaseOrderResponseUser)
    createdBy?: CreatePurchaseOrderResponseUser;
...
export class CreatePurchaseOrderResponse extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "data" })
    @Type(() => AccountingPurchaseOrder)
    data?: AccountingPurchaseOrder;
