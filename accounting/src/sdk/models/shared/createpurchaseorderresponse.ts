 ...
 */
export type CreatePurchaseOrderResponseUser = {
    /**
...
export type AccountingPurchaseOrder = {
     ...
     * The user who created the purchase order in the accounting system
     */
    createdBy?: CreatePurchaseOrderResponseUser | undefined;
    /**
...
export type CreatePurchaseOrderResponse = {
    ...
    data?: AccountingPurchaseOrder | null | undefined;
    /**
...
/** @internal */
export namespace CreatePurchaseOrderResponseUser$ {
    export type Inbound = {
        email?: string | null | undefined;
        firstName?: string | null | undefined;
        lastName?: string | null | undefined;
    ...
    export const inboundSchema: z.ZodType<CreatePurchaseOrderResponseUser, z.ZodTypeDef, Inbound> =
        z
            .object({
...
export namespace AccountingPurchaseOrder$ {
    export type Inbound = {
        createdBy?: CreatePurchaseOrderResponseUser$.Inbound | undefined;
        currency?: string | undefined;
    ...
    export const inboundSchema: z.ZodType<AccountingPurchaseOrder, z.ZodTypeDef, Inbound> = z
        .object({
            createdBy: z.lazy(() => CreatePurchaseOrderResponseUser$.inboundSchema).optional(),
    ...
    export type Outbound = {
        createdBy?: CreatePurchaseOrderResponseUser$.Outbound | undefined;
        currency?: string | undefined;
        currencyRate?: number | null | undefined;
        deliveryDate?: string | undefined;
        expectedDeliveryDate?: string | undefined;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingPurchaseOrder> = z
        .object({
            createdBy: z.lazy(() => CreatePurchaseOrderResponseUser$.outboundSchema).optional(),
            currency: z.string().optional(),
            currencyRate: z
                .nullable(
                    z
...
export namespace CreatePurchaseOrderResponse$ {
    export type Inbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: AccountingPurchaseOrder$.Inbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const inboundSchema: z.ZodType<CreatePurchaseOrderResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            data: z.nullable(z.lazy(() => AccountingPurchaseOrder$.inboundSchema)).optional(),
    ...
    export type Outbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: AccountingPurchaseOrder$.Outbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreatePurchaseOrderResponse> = z
        .object({
            ...
            companyId: z.string(),
            completedOnUtc: z.string().optional(),
            data: z.nullable(z.lazy(() => AccountingPurchaseOrder$.outboundSchema)).optional(),
            dataConnectionKey: z.string(),
            dataType: DataType$.optional(),
            errorMessage: z.nullable(z.string()).optional(),
            pushOperationKey: z.string(),
