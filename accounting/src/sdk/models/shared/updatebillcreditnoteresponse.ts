 ...
 */
export type UpdateBillCreditNoteResponseAccountingBillCreditNote = {
    /**
...
export type UpdateBillCreditNoteResponse = {
    ...
    data?: UpdateBillCreditNoteResponseAccountingBillCreditNote | null | undefined;
    /**
...
/** @internal */
export namespace UpdateBillCreditNoteResponseAccountingBillCreditNote$ {
    export type Inbound = {
        allocatedOnDate?: string | undefined;
        billCreditNoteNumber?: string | null | undefined;
...
export namespace UpdateBillCreditNoteResponse$ {
    export type Inbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: UpdateBillCreditNoteResponseAccountingBillCreditNote$.Inbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const inboundSchema: z.ZodType<UpdateBillCreditNoteResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            data: z
                .nullable(
                    z.lazy(
                        () => UpdateBillCreditNoteResponseAccountingBillCreditNote$.inboundSchema
                    )
                )
                .optional(),
    ...
    export type Outbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: UpdateBillCreditNoteResponseAccountingBillCreditNote$.Outbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, UpdateBillCreditNoteResponse> = z
        .object({
            ...
            data: z
                .nullable(
                    z.lazy(
                        () => UpdateBillCreditNoteResponseAccountingBillCreditNote$.outboundSchema
                    )
                )
                .optional(),
            dataConnectionKey: z.string(),
