 ...
 */
export class UpdateBillCreditNoteResponseAccountingBillCreditNote extends SpeakeasyBase {
    /**
...
export class UpdateBillCreditNoteResponse extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "data" })
    @Type(() => UpdateBillCreditNoteResponseAccountingBillCreditNote)
    data?: UpdateBillCreditNoteResponseAccountingBillCreditNote;
