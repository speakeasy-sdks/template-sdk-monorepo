...
import { AccountStatus, AccountStatus$ } from "./accountstatus.js";
...
import { PushOperationChange, PushOperationChange$ } from "./pushoperationchange.js";
import { PushOperationStatus, PushOperationStatus$ } from "./pushoperationstatus.js";
import { SupplementalData, SupplementalData$ } from "./supplementaldata.js";
import { Validation, Validation$ } from "./validation.js";
import { ValidDataTypeLinks, ValidDataTypeLinks$ } from "./validdatatypelinks.js";
...
export namespace AccountingAccount$ {
    export const inboundSchema: z.ZodType<AccountingAccount, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingAccount> = z.object({
        currency: z.string().optional(),
        currentBalance: z
            .nullable(
                z
...
export namespace CreateAccountResponse$ {
    export const inboundSchema: z.ZodType<CreateAccountResponse, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateAccountResponse> =
        z.object({
