...
export namespace AccountPrototype$ {
  /** @deprecated use `AccountPrototype$inboundSchema` instead. */
  export const inboundSchema = AccountPrototype$inboundSchema;
  /** @deprecated use `AccountPrototype$outboundSchema` instead. */
