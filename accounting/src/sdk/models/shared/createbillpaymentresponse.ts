...
import { BillPaymentLine, BillPaymentLine$ } from "./billpaymentline";
import { DataType, DataType$ } from "./datatype";
import { Metadata, Metadata$ } from "./metadata";
import { PaymentMethodRef, PaymentMethodRef$ } from "./paymentmethodref";
...
export namespace AccountingBillPayment$ {
    export type Inbound = {
        ...
        date: string;
        id?: string | undefined;
        lines?: Array<BillPaymentLine$.Inbound> | null | undefined;
        metadata?: Metadata$.Inbound | undefined;
        modifiedDate?: string | undefined;
        note?: string | null | undefined;
        paymentMethodRef?: PaymentMethodRef$.Inbound | undefined;
        reference?: string | null | undefined;
        sourceModifiedDate?: string | undefined;
    ...
    export const inboundSchema: z.ZodType<AccountingBillPayment, z.ZodTypeDef, Inbound> = z
        .object({
        ...
        .transform((v) => {
            return {
                ...
                ...(v.paymentMethodRef === undefined
                    ? null
                    : { paymentMethodRef: v.paymentMethodRef }),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingBillPayment> = z
        .object({
...
export namespace CreateBillPaymentResponse$ {
    export type Inbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: AccountingBillPayment$.Inbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
    ...
    export const inboundSchema: z.ZodType<CreateBillPaymentResponse, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            data: z.nullable(z.lazy(() => AccountingBillPayment$.inboundSchema)).optional(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateBillPaymentResponse> = z
        .object({
            ...
            companyId: z.string(),
            completedOnUtc: z.string().optional(),
            data: z.nullable(z.lazy(() => AccountingBillPayment$.outboundSchema)).optional(),
            dataConnectionKey: z.string(),
            dataType: DataType$.optional(),
            errorMessage: z.nullable(z.string()).optional(),
            pushOperationKey: z.string(),
