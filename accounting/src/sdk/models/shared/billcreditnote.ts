...
/** @internal */
export namespace BillCreditNote$ {
    export type Inbound = {
        allocatedOnDate?: string | undefined;
        billCreditNoteNumber?: string | null | undefined;
    ...
    export const inboundSchema: z.ZodType<BillCreditNote, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BillCreditNote> = z
        .object({
            allocatedOnDate: z.string().optional(),
            billCreditNoteNumber: z.nullable(z.string()).optional(),
