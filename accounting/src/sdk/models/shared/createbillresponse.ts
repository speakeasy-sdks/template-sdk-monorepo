...
export class CreateBillResponseWithholdingTax extends SpeakeasyBase {
    /**
...
export class AccountingBill extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata({ elemType: CreateBillResponseWithholdingTax })
    @Expose({ name: "withholdingTax" })
    @Type(() => CreateBillResponseWithholdingTax)
    withholdingTax?: CreateBillResponseWithholdingTax[];
}
