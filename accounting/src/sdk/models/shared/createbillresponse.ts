...
export namespace CreateBillResponseWithholdingTax$ {
    ...
    export const inboundSchema: z.ZodType<CreateBillResponseWithholdingTax, z.ZodTypeDef, Inbound> =
        z
            .object({
...
export namespace AccountingBill$ {
    export type Inbound = {
        ...
        taxAmount: number;
        totalAmount: number;
        withholdingTax?: Array<CreateBillResponseWithholdingTax$.Inbound> | null | undefined;
    };
    ...
    export const inboundSchema: z.ZodType<AccountingBill, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            withholdingTax: z
                .nullable(z.array(z.lazy(() => CreateBillResponseWithholdingTax$.inboundSchema)))
                .optional(),
        })
        .transform((v) => {
            return {
    ...
    export type Outbound = {
        ...
        taxAmount: number;
        totalAmount: number;
        withholdingTax?: Array<CreateBillResponseWithholdingTax$.Outbound> | null | undefined;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, AccountingBill> = z
        .object({
            ...
            totalAmount: z
                ...
                .transform((v) => (typeof v === "number" ? v : v.toNumber())),
            withholdingTax: z
                .nullable(z.array(z.lazy(() => CreateBillResponseWithholdingTax$.outboundSchema)))
                .optional(),
        })
        .transform((v) => {
            return {
...
export namespace CreateBillResponse$ {
    export type Inbound = {
        ...
        companyId: string;
        completedOnUtc?: string | undefined;
        data?: AccountingBill$.Inbound | null | undefined;
        dataConnectionKey: string;
        dataType?: DataType | undefined;
        errorMessage?: string | null | undefined;
        pushOperationKey: string;
