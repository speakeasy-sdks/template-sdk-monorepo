...
import { CashFlowStatement, CashFlowStatement$ } from "./cashflowstatement";
import { ReportBasis, ReportBasis$ } from "./reportbasis";
import { ReportInput, ReportInput$ } from "./reportinput";
...
/** @internal */
export namespace CashFlowStatementInput$ {
    export type Inbound = {
        currency: string;
        earliestAvailableMonth?: string | undefined;
        mostRecentAvailableMonth?: string | undefined;
        reportBasis: ReportBasis;
        reportInput: ReportInput;
        reports: Array<CashFlowStatement$.Inbound>;
    };

    export const inboundSchema: z.ZodType<CashFlowStatementInput, z.ZodTypeDef, Inbound> = z
        .object({
            currency: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CashFlowStatementInput> = z
        .object({
            currency: z.string(),
            earliestAvailableMonth: z.string().optional(),
            mostRecentAvailableMonth: z.string().optional(),
