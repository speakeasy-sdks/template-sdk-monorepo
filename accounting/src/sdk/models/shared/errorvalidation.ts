...
export namespace ErrorValidation$ {
    export const inboundSchema: z.ZodType<ErrorValidation, z.ZodTypeDef, unknown> = z.object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ErrorValidation> = z.object({
