...
import { BalanceSheet, BalanceSheet$ } from "./balancesheet";
...
/** @internal */
export namespace BalanceSheetInput$ {
    export type Inbound = {
        currency: string;
        earliestAvailableMonth?: string | undefined;
        mostRecentAvailableMonth?: string | undefined;
        reports: Array<BalanceSheet$.Inbound>;
    };

    export const inboundSchema: z.ZodType<BalanceSheetInput, z.ZodTypeDef, Inbound> = z
        .object({
            currency: z.string(),
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, BalanceSheetInput> = z
        .object({
            currency: z.string(),
            earliestAvailableMonth: z.string().optional(),
            mostRecentAvailableMonth: z.string().optional(),
