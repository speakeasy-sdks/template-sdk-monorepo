...
import { PurchaseOrder, PurchaseOrder$ } from "./purchaseorder";
...
export type PurchaseOrders = {
     ...
     */
    pageSize: number;
    results?: Array<PurchaseOrder> | undefined;
    /**
...
export namespace PurchaseOrders$ {
    export type Inbound = {
        ...
        pageNumber: number;
        pageSize: number;
        results?: Array<PurchaseOrder$.Inbound> | undefined;
        totalResults: number;
    };
    ...
    export const inboundSchema: z.ZodType<PurchaseOrders, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            results: z.array(PurchaseOrder$.inboundSchema).optional(),
    ...
    export type Outbound = {
        ...
        pageNumber: number;
        pageSize: number;
        results?: Array<PurchaseOrder$.Outbound> | undefined;
        totalResults: number;
    };
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, PurchaseOrders> = z
        .object({
            ...
            pageNumber: z.number().int(),
            pageSize: z.number().int(),
            results: z.array(PurchaseOrder$.outboundSchema).optional(),
            totalResults: z.number().int(),
        })
        .transform((v) => {
            return {
