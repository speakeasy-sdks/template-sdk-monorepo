...
export class Bills {
    ...
    async delete(
        ...
        const req = new operations.DeleteBillRequest({
            billId: billId,
            companyId: companyId,
            connectionId: connectionId,
        });
    ...
    async downloadAttachment(
        ...
        const req = new operations.DownloadBillAttachmentRequest({
    ...
    async getAttachment(
        ...
        const req = new operations.GetBillAttachmentRequest({
            attachmentId: attachmentId,
            billId: billId,
            companyId: companyId,
            connectionId: connectionId,
    ...
    async getCreateUpdateModel(
        ...
        const req = new operations.GetCreateUpdateBillsModelRequest({
            companyId: companyId,
            connectionId: connectionId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async listAttachments(
        ...
        const req = new operations.ListBillAttachmentsRequest({
            billId: billId,
            companyId: companyId,
            connectionId: connectionId,
        });
    ...
    async uploadAttachment(
        ...
        const req = new operations.UploadBillAttachmentRequest({
            billId: billId,
            companyId: companyId,
            connectionId: connectionId,
