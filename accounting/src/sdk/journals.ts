...
export class Journals {
    ...
    async create(
        ...
        const req = new operations.CreateJournalRequest({
            companyId: companyId,
        ...
        try {
            [reqBodyHeaders, reqBody] = utils.serializeRequestBody(req, "journalPrototype", "json");
        } catch (e: unknown) {
    ...
    async get(
        ...
        const req = new operations.GetJournalRequest({
            companyId: companyId,
            journalId: journalId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async getCreateModel(
        ...
        const req = new operations.GetCreateJournalsModelRequest({
            companyId: companyId,
            connectionId: connectionId,
        });
        const baseURL: string = utils.templateUrl(
