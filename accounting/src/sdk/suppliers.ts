...
export class Suppliers {
    ...
    async create(
        ...
        const req = new operations.CreateSupplierRequest({
            companyId: companyId,
    ...
    async downloadAttachment(
        ...
        const req = new operations.DownloadSupplierAttachmentRequest({
    ...
    async get(
        ...
        const req = new operations.GetSupplierRequest({
            companyId: companyId,
            supplierId: supplierId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async getAttachment(
        ...
        const req = new operations.GetSupplierAttachmentRequest({
            attachmentId: attachmentId,
            companyId: companyId,
            connectionId: connectionId,
            supplierId: supplierId,
    ...
    async getCreateUpdateModel(
        ...
        const req = new operations.GetCreateUpdateSuppliersModelRequest({
            companyId: companyId,
            connectionId: connectionId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async listAttachments(
        ...
        const req = new operations.ListSupplierAttachmentsRequest({
            companyId: companyId,
            connectionId: connectionId,
            supplierId: supplierId,
        });
