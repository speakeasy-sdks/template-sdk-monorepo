...
export class BankAccountTransactions extends ClientSDK {
     ...
     */
    async create(
        input: operations.CreateBankTransactionsRequest,
        ...
        const body$ = enc$.encodeJSON("body", payload$.CreateBankTransactions, { explode: true });
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.CreateBankTransactionsResponse$.inboundSchema.parse({
                        ...responseFields$,
                        CreateBankTransactionsResponse: val$,
                    });
                },
    ...
    async getCreateModel(
        ...
        const input$: operations.GetCreateBankTransactionsModelRequest = {
            accountId: accountId,
            companyId: companyId,
        ...
        const payload$ = schemas$.parse(
            input$,
            (value$) =>
                operations.GetCreateBankTransactionsModelRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.GetCreateBankTransactionsModelResponse$.inboundSchema.parse({
                        ...responseFields$,
                        PushOption: val$,
                    });
                },
     ...
     */
    async list(
        input: operations.ListBankAccountTransactionsRequest,
        options?: RequestOptions & { retries?: retries$.RetryConfig }
        ...
        const payload$ = schemas$.parse(
            input,
            (value$) => operations.ListBankAccountTransactionsRequest$.outboundSchema.parse(value$),
            "Input validation failed"
        );
        const body$ = null;
        ...
        if (this.matchResponse(response, 200, "application/json")) {
            ...
            const result = schemas$.parse(
                responseBody,
                (val$) => {
                    return operations.ListBankAccountTransactionsResponse$.inboundSchema.parse({
                        ...responseFields$,
                        BankTransactions: val$,
                    });
                },
                "Response validation failed"
            );
