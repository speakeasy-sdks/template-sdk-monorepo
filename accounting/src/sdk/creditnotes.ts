...
export class CreditNotes {
    ...
    async create(
        ...
        const req = new operations.CreateCreditNoteRequest({
            companyId: companyId,
    ...
    async get(
        ...
        const req = new operations.GetCreditNoteRequest({
            companyId: companyId,
    ...
    async getCreateUpdateModel(
        ...
        const req = new operations.GetCreateUpdateCreditNotesModelRequest({
            companyId: companyId,
            connectionId: connectionId,
        });
        const baseURL: string = utils.templateUrl(
