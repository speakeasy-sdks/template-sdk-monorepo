...
export class PurchaseOrders {
    ...
    async downloadAttachment(
        ...
        const req = new operations.DownloadPurchaseOrderAttachmentRequest({
    ...
    async getAttachment(
        ...
        const req = new operations.GetPurchaseOrderAttachmentRequest({
            attachmentId: attachmentId,
            companyId: companyId,
            connectionId: connectionId,
            purchaseOrderId: purchaseOrderId,
    ...
    async getCreateUpdateModel(
        ...
        const req = new operations.GetCreateUpdatePurchaseOrdersModelRequest({
            companyId: companyId,
            connectionId: connectionId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async listAttachments(
        ...
        const req = new operations.ListPurchaseOrderAttachmentsRequest({
            companyId: companyId,
            connectionId: connectionId,
            purchaseOrderId: purchaseOrderId,
        });
