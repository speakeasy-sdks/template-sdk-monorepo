...
export class BillCreditNotes {
    ...
    async create(
        ...
        const req = new operations.CreateBillCreditNoteRequest({
            companyId: companyId,
    ...
    async get(
        ...
        const req = new operations.GetBillCreditNoteRequest({
    ...
    async getCreateUpdateModel(
        ...
        const req = new operations.GetCreateUpdateBillCreditNotesModelRequest({
            companyId: companyId,
            connectionId: connectionId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async uploadAttachment(
        ...
        const req = new operations.UploadBillCreditNoteAttachmentRequest({
            billCreditNoteId: billCreditNoteId,
            companyId: companyId,
            connectionId: connectionId,
