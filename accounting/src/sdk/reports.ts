...
export class Reports {
    ...
    async getAgedCreditorsReport(
        ...
        const req = new operations.GetAgedCreditorsReportRequest({
            companyId: companyId,
    ...
    async getAgedDebtorsReport(
        ...
        const req = new operations.GetAgedDebtorsReportRequest({
            companyId: companyId,
            numberOfPeriods: numberOfPeriods,
            periodLengthDays: periodLengthDays,
            reportDate: reportDate,
    ...
    async getBalanceSheet(
        ...
        const req = new operations.GetBalanceSheetRequest({
            companyId: companyId,
    ...
    async getCashFlowStatement(
        ...
        const req = new operations.GetCashFlowStatementRequest({
            companyId: companyId,
            periodLength: periodLength,
            periodsToCompare: periodsToCompare,
            startMonth: startMonth,
    ...
    async getProfitAndLoss(
        ...
        const req = new operations.GetProfitAndLossRequest({
            companyId: companyId,
            periodLength: periodLength,
            periodsToCompare: periodsToCompare,
            startMonth: startMonth,
    ...
    async isAgedCreditorsReportAvailable(
        ...
        const req = new operations.IsAgedCreditorsReportAvailableRequest({
            companyId: companyId,
        });
        const baseURL: string = utils.templateUrl(
            this.sdkConfiguration.serverURL,
    ...
    async isAgedDebtorReportAvailable(
        ...
        const req = new operations.IsAgedDebtorReportAvailableRequest({
            companyId: companyId,
        });
        const baseURL: string = utils.templateUrl(
            this.sdkConfiguration.serverURL,
