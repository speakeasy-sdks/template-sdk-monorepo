...
export class Invoices {
    ...
    async downloadAttachment(
        ...
        const req = new operations.DownloadInvoiceAttachmentRequest({
    ...
    async downloadPdf(
        ...
        const req = new operations.DownloadInvoicePdfRequest({
            companyId: companyId,
            invoiceId: invoiceId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async getAttachment(
        ...
        const req = new operations.GetInvoiceAttachmentRequest({
            attachmentId: attachmentId,
            companyId: companyId,
            connectionId: connectionId,
            invoiceId: invoiceId,
    ...
    async getCreateUpdateModel(
        ...
        const req = new operations.GetCreateUpdateInvoicesModelRequest({
            companyId: companyId,
            connectionId: connectionId,
        });
        const baseURL: string = utils.templateUrl(
    ...
    async listAttachments(
        ...
        const req = new operations.ListInvoiceAttachmentsRequest({
            companyId: companyId,
            connectionId: connectionId,
            invoiceId: invoiceId,
        });
    ...
    async uploadAttachment(
        ...
        const req = new operations.UploadInvoiceAttachmentRequest({
            companyId: companyId,
            connectionId: connectionId,
            invoiceId: invoiceId,
